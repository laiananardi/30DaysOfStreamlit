...
def load_data():
    ...
    df_agg_sub = pd.read_csv('assets/Aggregated_Metrics_By_Country_And_Subscriber_Status.csv')
    df_comments = pd.read_csv('assets/Aggregated_Metrics_By_Video.csv')
    df_time = pd.read_csv('assets/Video_Performance_Over_Time.csv')
...
if add_sidebar == 'Aggregate Metrics':
    ...
    for i in metric_medians6mo.index:
        with columns[count]:
            print(type(metric_medians6mo[i]))
            print(type(metric_medians12mo[i]))
